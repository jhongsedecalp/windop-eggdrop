...
##### Bot motd.. This char will make a new line: 
	set dop(botmotd) "JhongScript v1.0 visit us http://makati-undernet.tk"
##### Report admin actions
	#[ON: 1, OFF: 0]
	set dop(adminreport) 1
	#Report channel
	set dop(adminreportchan) "#jh0ng"
...
##### Add the username in the kick reason
	#[ON: 1, OFF: 0]
	set dop(kickusername) 0
##### Channel misc
	#After how many minutes the bot will remove a ban
	set dop(defban) 60
##### Password
...
###########################################
### Let this line to 1 else some windop command will crap
...
set dop(tclversion) "Windop TCL v3.2 - You can get it @ http://www.freewebs.com/windop"
...
putlog "\r"
putlog "_-¯->Windop TCL v3.2 LOADED!!!<-¯-_\r"
putlog "_-¯->You can get it @ http://www.freewebs.com/windop<-¯-_\r"
...
proc dop:checkupdate {min hour day month year} {
	...
	if {[info tclversion] >= 8.0} {
		if {$dop(upautocheck) == 1} {
			...
			set url "http://www.freewebs.com/windop"
